...
a030_323:
    changemondatabyvar VAR_OP_GET_RESULT, BATTLER_ATTACKER, MON_DATA_SPEED, VAR_MOVE_TEMP
    changemondatabyvar VAR_OP_GET_RESULT, BATTLER_DEFENDER, MON_DATA_SPEED, VAR_TEMP_WORK
    changevar VAR_OP_MUL, VAR_MOVE_TEMP, 4096
    changevar VAR_OP_DIV, VAR_MOVE_TEMP, VAR_TEMP_WORK
    if IF_LESSTHAN, VAR_MOVE_TEMP, 4096/4, _150bp
    if IF_LESSTHAN, VAR_MOVE_TEMP, 4096/3, _120bp
    if IF_LESSTHAN, VAR_MOVE_TEMP, 4096/2, _80bp
    if IF_LESSTHAN, VAR_MOVE_TEMP, 4096, _60bp
_40bp:
