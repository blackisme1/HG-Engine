...
movedata MOVE_SUBMISSION, "Submission"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_SUBMISSION, "A reckless, life-\nrisking tackle.\nIt also damages the\nuser by a fairly large\namount, however."
...
movedata MOVE_SOLAR_BEAM, "Solar Beam"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_SOLAR_BEAM, "A two turn attack.\nThe user gathers\nlight and increases its\nSpecial Attack, then blasts a\nbundled beam on the\nsecond turn."
...
movedata MOVE_BIDE, "Bide"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_BIDE, "The user retaliates\nagainst the foe that\nlast inflicted damage\non it with much\ngreater power."
...
movedata MOVE_SKY_ATTACK, "Sky Attack"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_SKY_ATTACK, "The user gathers wind power\nand boosts its Sp. Atk stat\non the first turn,\nthen attacks on the next turn."
...
movedata MOVE_NIGHTMARE, "Nightmare"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_NIGHTMARE, "A foe is slept and\nshown a nightmare\nthat inflicts some\ndamage every turn.\n"
...
movedata MOVE_SNORE, "Snore"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_SNORE, "An attack that deals\ndouble damage if the\nuser is asleep. It\nmay also make\nthe foe flinch."
...
movedata MOVE_OCTAZOOKA, "Octazooka"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_OCTAZOOKA, "The user gathers ink and\nboosts its Sp. Atk stat\non the first turn, then\nattacks on the next turn."
...
movedata MOVE_ATTRACT, "Attract"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_ATTRACT, "The foe is charmed and\ntheir Accuracy is lowered."
...
movedata MOVE_WHIRLPOOL, "Whirlpool"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_WHIRLPOOL, "A spin attack that\ncan also eliminate\nsuch moves as Bind,\nWrap, Leech Seed,\nand Spikes."
...
movedata MOVE_UPROAR, "Uproar"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_UPROAR, "This attack flinches and\ndoubles damage on a\nsleeping foe. It\nalso wakes the foe\nup, however."
...
movedata MOVE_DIVE, "Dive"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_DIVE, "After making its\nattack, the user\nrushes back to switch\nplaces with a party\nPokémon in waiting."
...
movedata MOVE_POISON_TAIL, "Poison Tail"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_POISON_TAIL, "This vicious tail attack\nis sure to poison\nthe foe."
...
movedata MOVE_WATER_SPORT, "Water Sport"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_WATER_SPORT, "The user boosts the\npower of the W\nmove it uses next."
...
movedata MOVE_PAYBACK, "Payback"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_PAYBACK, "An attack move that\ninflicts double the\ndamage if the user\nhas been hurt by the\nfoe in the same turn."
...
movedata MOVE_TRUMP_CARD, "Trump Card"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_TRUMP_CARD, "An all out final\nattack. It doesnt\nwork the first turn\nthe user is in battle."
...
movedata MOVE_LAST_RESORT, "Last Resort"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_LAST_RESORT, "An all out final\nattack. It doesnt\nwork the first turn\nthe user is in battle."
...
movedata MOVE_FOCUS_BLAST, "Focus Sphere"
    battleeffect 72
    pss SPLIT_SPECIAL
    basepower 120
    type TYPE_FIGHTING
...
movedata MOVE_SYNCHRONOISE, "Synchrony"
    battleeffect 0
    pss SPLIT_SPECIAL
    basepower 120
    type TYPE_PSYCHIC
...
movedata MOVE_RETALIATE, "Retaliate"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_RETALIATE, "An attack move that\ninflicts double the\ndamage if the user\nhas been hurt by the\nfoe in the same turn."
...
movedata MOVE_NIGHT_DAZE, "Deception"
    battleeffect 0
    pss SPLIT_SPECIAL
    basepower 80
    type TYPE_DARK
...
movedata MOVE_V_CREATE, "V create"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_V_CREATE, "The user attacks the\nfoe without\nguarding itself. It\nalso cuts the user’s\nDefense, Sp. Def and Speed."
...
movedata MOVE_DISARMING_VOICE, "Disarming Voice"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_DISARMING_VOICE, "Letting out a charming cry,\nthe user does emotional\ndamage to opposing Pokémon."
...
movedata MOVE_PLAY_ROUGH, "Play Rough"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_PLAY_ROUGH, "The user plays rough with\nthe target and attacks\nit. This may also lower\nthe target's Attack stat."
...
movedata MOVE_MOONBLAST, "Moonblast"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_MOONBLAST, "Borrowing the power of the moon,\nthe user attacks the target.\nThis may also lower\nthe target's Sp. Atk stat."
...
movedata MOVE_ELECTRIC_TERRAIN, "ElectricTerrain"
    ...
    flags FLAG_MIRROR_MOVE | FLAG_PROTECT | FLAG_MAGIC_COAT
    appeal 0x00
    contesttype 0x00 // Prior to Pokémon Omega Ruby and Alpha Sapphire, it was known as the Smart condition.
    terminatedata
...
movedata MOVE_DAZZLING_GLEAM, "Dazzling Gleam"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_DAZZLING_GLEAM, "The user damages opposing\nPokémon by emitting\na powerful flash."
...
movedata MOVE_BABY_DOLL_EYES, "Baby Doll Eyes"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_BABY_DOLL_EYES, "The user stares at the target\nwith its baby doll eyes,\nwhich lowers its Attack stat.\nThis move always goes first."
...
movedata MOVE_DRAGON_ASCENT, "Dragon Ascent"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_DRAGON_ASCENT, "The user attacks the\nfoe without\nguarding itself. It\nalso cuts the user’s\nDefense, Sp. Def and Speed."
...
movedata MOVE_HYPERSPACE_FURY, "Hyperspace Fury"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_HYPERSPACE_FURY, "The user attacks the\nfoe without\nguarding itself. It\nalso cuts the user’s\nDefense, Sp. Def and Speed."
...
movedata MOVE_FIRST_IMPRESSION, "Impression"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_FIRST_IMPRESSION, "An attack that hits\nfirst. It only\nworks the first turn\nthe user is in battle."
...
movedata MOVE_TOXIC_THREAD, "Toxic Thread"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_TOXIC_THREAD, "The user shoots poisonous\nthreads to badly poison and\nlower the target's Speed stat."
...
movedata MOVE_REVELATION_DANCE, "Reveal Dance"
    battleeffect 0
    pss SPLIT_SPECIAL
    basepower 90
    type TYPE_NORMAL
...
movedata MOVE_CLANGING_SCALES, "Clang Scales"
    battleeffect 291
    pss SPLIT_SPECIAL
    basepower 120
    type TYPE_DRAGON
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_CLANGING_SCALES, "The user attacks the\nfoe without\nguarding itself. It\nalso cuts the user’s\nDefense, Sp. Def and Speed."
...
movedata MOVE_SINISTER_ARROW_RAID, "Arrow Raid"
    battleeffect 0
    pss SPLIT_PHYSICAL
    basepower 180
    type TYPE_GHOST
...
movedata MOVE_MALICIOUS_MOONSAULT, "Moonsault"
    battleeffect 0
    pss SPLIT_PHYSICAL
    basepower 180
    type TYPE_DARK
...
movedata MOVE_OCEANIC_OPERETTA, "Operetta"
    battleeffect 0
    pss SPLIT_SPECIAL
    basepower 195
    type TYPE_WATER
...
movedata MOVE_GUARDIAN_OF_ALOLA, "Guardian"
    battleeffect 40
    pss SPLIT_SPECIAL
    basepower 0
    type TYPE_FAIRY
...
movedata MOVE_SOUL_STEALING_7_STAR_STRIKE, "S.S.S.S.S."
    battleeffect 0
    pss SPLIT_PHYSICAL
    basepower 195
    type TYPE_GHOST
...
movedata MOVE_STOKED_SPARKSURFER, "Sparksurfer"
    battleeffect 6
    pss SPLIT_SPECIAL
    basepower 175
    type TYPE_ELECTRIC
...
movedata MOVE_PULVERIZING_PANCAKE, "Pancake"
    battleeffect 0
    pss SPLIT_PHYSICAL
    basepower 210
    type TYPE_NORMAL
...
movedata MOVE_EXTREME_EVOBOOST, "Evoboost"
    battleeffect 0
    pss SPLIT_STATUS
    basepower 0
    type TYPE_NORMAL
...
movedata MOVE_GENESIS_SUPERNOVA, "Supernova"
    battleeffect 0
    pss SPLIT_SPECIAL
    basepower 185
    type TYPE_PSYCHIC
...
movedata MOVE_STOMPING_TANTRUM, "Stomp Tantrum"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_STOMPING_TANTRUM, "The user rampages\nand attacks for two\nturns. However, it then\nbecomes confused."
...
movedata MOVE_TEARFUL_LOOK, "Tearful Look"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_TEARFUL_LOOK, "The user makes the target\nlose its combative spirit.\nThis lowers the target's\nSp. Atk stat."
...
movedata MOVE_10_000_000_VOLT_THUNDERBOLT, "10 Bil. Bolt"
    battleeffect 0
    pss SPLIT_SPECIAL
    basepower 195
    type TYPE_ELECTRIC
...
movedata MOVE_LIGHT_THAT_BURNS_THE_SKY, "Burning Light"
    battleeffect 0
    pss SPLIT_SPECIAL
    basepower 200
    type TYPE_PSYCHIC
...
movedata MOVE_SEARING_SUNRAZE_SMASH, "Sunraze"
    battleeffect 0
    pss SPLIT_PHYSICAL
    basepower 200
    type TYPE_STEEL
...
movedata MOVE_MENACING_MOONRAZE_MAELSTROM, "Maestrom"
    battleeffect 0
    pss SPLIT_SPECIAL
    basepower 200
    type TYPE_GHOST
...
movedata MOVE_LETS_SNUGGLE_FOREVER, "Snuggle"
    battleeffect 0
    pss SPLIT_PHYSICAL
    basepower 190
    type TYPE_FAIRY
...
movedata MOVE_SPLINTERED_STORMSHARDS, "Stormshards"
    battleeffect 0
    pss SPLIT_PHYSICAL
    basepower 190
    type TYPE_ROCK
...
movedata MOVE_CLANGOROUS_SOULBLAZE, "Soulblaze"
    battleeffect 140
    pss SPLIT_SPECIAL
    basepower 185
    type TYPE_DRAGON
...
movedata MOVE_BOLT_BEAK, "Bolt Beak"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_BOLT_BEAK, "An attack that\ninflicts double damage\nif the user attacks\nbefore the target."
...
movedata MOVE_FISHIOUS_REND, "Fishious Rend"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_FISHIOUS_REND, "An attack that\ninflicts double damage\nif the user attacks\nbefore the target."
...
movedata MOVE_METEOR_BEAM, "Meteor Beam"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_METEOR_BEAM, "The user gathers energy from space\nand boosts its Sp. Atk stat\non the first turn,\nthen attacks on the next turn."
...
movedata MOVE_BURNING_JEALOUSY, "Jealousy"
    battleeffect 245
    pss SPLIT_SPECIAL
    basepower 1
    type TYPE_FIRE
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_BURNING_JEALOUSY, "This attack’s power\nincreases the more\nthe foe has powered\nup with stat changes.\n"
...
movedata MOVE_AXE_KICK, "Axe Kick"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_AXE_KICK, "This attack may also confuse the target. If it misses, the user takes damage instead."
...
movedata MOVE_GLAIVE_RUSH, "Glaive Rush"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_GLAIVE_RUSH, "The user attacks the\nfoe without\nguarding itself. It\nalso cuts the user’s\nDefense, Sp. Def and Speed."

movedata MOVE_REVIVAL_BLESSING, "Revive"
    battleeffect 0
    pss SPLIT_STATUS
    basepower 0
    type TYPE_NORMAL
...
movedata MOVE_RAGING_BULL, "Raging Bull"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_RAGING_BULL, "The user gathers up anger\nand boosts its Attack stat\non the first turn,\nthen attacks on the next turn."
...
movedata MOVE_MAKE_IT_RAIN, "Make It Rain"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_MAKE_IT_RAIN, "The user attacks the\nfoe without\nguarding itself. It\nalso cuts the user’s\nDefense, Sp. Def and Speed."
...
movedata MOVE_RAGE_FIST, "Rage Fist"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_RAGE_FIST, "While this move is in\nuse, it gains attack\npower each time the\nuser is hit in battle.\n"
...
movedata MOVE_ARMOR_CANNON, "Armor Cannon"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_ARMOR_CANNON, "The user attacks the\nfoe without\nguarding itself. It\nalso cuts the user’s\nDefense, Sp. Def and Speed."
...
movedata MOVE_PESTER, "Pester"
    ...
    contesttype 0x00
    terminatedata
    movedescription MOVE_PESTER, "An attack that\ninflicts double damage\nif the user attacks\nbefore the target."
