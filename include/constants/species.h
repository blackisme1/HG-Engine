...
#define SPECIES_CASTFORM_SANDY (SPECIES_MISC_FORM_START + 149)

#define MAX_MISC_FORM_NUM (SPECIES_CASTFORM_SANDY)

#define SPECIES_HISUIAN_REGIONAL_START (MAX_MISC_FORM_NUM + 1) // 1307
